...
from src.neural.train import rollout_dad
from src.rollout import FixedSelector, RandomSelector, RolloutResult, run_shared_rollout
...
def ensure_fixed_subset(
    *,
    ...
    from src.experiment_layout import eval_dir
