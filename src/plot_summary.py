...
DAD_METHODS = ("dad_spce", "dad_delta_h")
...
def _saturation_line(ax: plt.Axes, metric: str, *, spce_L: int = 512) -> None:
    if metric == "delta_h":
        ...
        from src.contrastive.spce import spce_info_ceiling
...
def plot_sweep_six_metrics(
    ...
    *,
    ...
    if out_dir is None:
        out_dir = project_root / "experiments" / "_plots" / "sweep_six"
...
def plot_all_summaries(
    ...
    *,
    ...
    if out_dir is None:
        out_dir = project_root / "experiments" / "_plots"
