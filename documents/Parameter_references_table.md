...
| **Inertia Range** | $M$ | [0.01, 0.06] $s^2/\text{rad}$ | From $M = 2H/\omega_s$; $H \in [2.3,\, 5.0]$ s (Kundur, typical machines). Kundur, P. (1994). *Power System Stability and Control*. McGraw-Hill. [https://www.mdpi.com/1996-1073/15/20/7767](https://www.mdpi.com/1996-1073/15/20/7767) |
| **Droop / primary frequency response gain** | $K$ | [0.05, 0.50] | Dörfler & Bullo (2012); NERC/ERCOT droop 4–6%. [https://arxiv.org/pdf/0910.5673](https://arxiv.org/pdf/0910.5673) |
| **Damping** | $D$ | 0.1 | Kundur, P. (1994). *Power System Stability and Control*. McGraw-Hill. |
| **Sampling Rate** | $f_s$ | 12 Hz | IEEE C37.118.1 (60 Hz: 10, 12, 15, 20, 30, 60 fps). [https://standards.ieee.org/ieee/C37.118.1/4902](https://standards.ieee.org/ieee/C37.118.1/4902) |
...
| **Likelihood Noise** | $\sigma$ | 0.01 (config); 0.05 (tests) | NASPI (2021). [https://www.naspi.org/node/899](https://www.naspi.org/node/899) |