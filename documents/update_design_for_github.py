...
# GitHub: 60% width, centered, aspect ratio preserved (no height set)
GITHUB_IMAGE_HTML = '''<div align="center">
...
IMAGE_MARKDOWN_PATTERN = re.compile(
    r"!\[[^\]]*\]\s*\(\s*" + re.escape(IMAGE_PATH_IN_DOC) + r"\s*\)"
)
...
def update_image_path(text: str) -> str:
    text = OLD_IMAGE_PATTERN.sub(IMAGE_PATH_IN_DOC, text)
    return text
