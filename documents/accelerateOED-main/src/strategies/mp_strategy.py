...
from src.utils.paths import get_model_file, get_statistics_file
import torch
import numpy as np
...
def getMPSequence(gpu, q, syncThresholds, isSynchronized, w, N, aLowerBoundIn, aUpperBoundIn,
    ...
    model_path = get_model_file(trained_model_name)
    stats_path = get_statistics_file(trained_model_name)
